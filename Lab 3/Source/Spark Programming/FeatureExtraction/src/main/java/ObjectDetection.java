...
/**
 * Created by Zeenat & Khushal on 02-28-2018.
 */
...
class ObjectMainDetection {
    ...
    public void StartVideo() throws IOException {
        Video<MBFImage> video = new XuggleVideo(new File("data/Video.mkv"));
    ...
    public void LoadReferenceObject() {
        ...
        try {
            modelImage1 = ImageUtilities.readMBF(new File("data/Apple.png"));
            modelImage2 = ImageUtilities.readMBF(new File("data/Grapes.png"));
            modelImage3 = ImageUtilities.readMBF(new File("data/Strawberry.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
