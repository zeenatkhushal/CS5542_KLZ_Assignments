...
object ImageClassification_NB {
  def main(args: Array[String]) {
    val IMAGE_CATEGORIES = Array("Apple", "Grapes", "Strawberry")
   ...
   val numTrees = 5
    ...
    //val Array(trainingData, test) = data.randomSplit(Array(0.6, 0.4))
    val model = NaiveBayes.train(parsedData, lambda = 1.0, modelType="multimonial")
